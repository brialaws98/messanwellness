...
import "./Service.css";
 ...
 export default function Services () {
  ...
  <div class="card-body">
    ...
    <p class="card-text">Specializing in Deep Tissue, Swedish or Hot Stone therapy. We provide custom massage treatments so that you can take charge of your health and well-being. </p>
...
Pronounced (Ray-Key) is an energy-based healing technique used to activate the natural healing processes of the body and restore physical and emotional well-being.</p>
  ...
  <div class="card-body">
    ...
    <p class="card-text">Through hypnosis we use your most powerful resource - your mind - to help you overcome obstacles that prevent you from becoming the absolute best you can be. Specializing in Past Life Regression and future life progression. </p>
    <a href="#" class="btn btn-primary">Book Now</a>
  </div>
</div>
          </div>
